...
[![65 Commands](https://img.shields.io/badge/commands-65-orange)](skills/chrome-cdp-ex/scripts/cdp.mjs)
...
- You want long-session memory: console/network buffers, screenshots, reports, checkpoints, throttled network profiles, and replay.
...
| Long-session debugging | `status`, `netlog`, `throttle`, screenshots, and `report` preserve evidence across a live tab session. |
...
- [Commands (65 total)](#commands-65-total)
...
| **Commands** | **65** | N/A (programmatic API) | ~14 |
...
All 65 commands work: `perceive`, `frame`, `overlay`, `click`, `fill`, `cascade`, `record`, `checkpoint`, `restore`, `record-actions`, `export-playwright`, `diff-shot`, `replay`, `throttle`, `report`, `inject`, `flow`, `repeat`, `doctor`, and more.
