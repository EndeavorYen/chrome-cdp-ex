...
The current checked boundary has 25 daemon groups,
52 application-owned handlers, and 16 remaining switch-branch
deletion candidates.
...
while the other 29 catalog commands return an explicit
