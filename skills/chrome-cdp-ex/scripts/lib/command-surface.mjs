...
const COMMAND_SURFACE_INPUT = [
  ...
  {"name":"scroll","aliases":[],"needsTarget":true,"mutates":true,"feedbackPolicy":"settle-diff","outputFormats":["text","json"],"kind":"mutation","authorization":"mutation","evidencePolicy":"action-receipt","domains":["Runtime"],"help":{"synopsis":"scroll <target> <dir|x,y|to top|to bottom> [px] [--format json]","summary":"Scroll page (down/up/left/right or x,y offset; default 500px; to top/bottom for the window document)","order":43,"section":"interaction"},"mcp":{"exposure":"run-command","toolName":null,"mapper":null}},
...
export const COMMAND_SURFACE_IDENTITY = '827da3840ec792bc91f0a3f32ef14713e1a9b10ebb3a3987419e002bdaf190ad';
