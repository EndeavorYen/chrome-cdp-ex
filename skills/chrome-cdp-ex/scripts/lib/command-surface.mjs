...
const COMMAND_SURFACE_INPUT = [
  ...
  {"name":"scroll","aliases":[],"needsTarget":true,"mutates":true,"feedbackPolicy":"settle-diff","outputFormats":["text","json"],"kind":"mutation","authorization":"mutation","evidencePolicy":"action-receipt","domains":["Runtime"],"help":{"synopsis":"scroll <target> <dir|x,y|to top|to bottom> [px] [--scroll-container SELECTOR] [--format json] [--qa|--summary] [--compact]","summary":"Scroll page (down/up/left/right or x,y offset; default 500px; to top/bottom for the window document or nested overflow)","order":43,"section":"interaction"},"mcp":{"exposure":"run-command","toolName":null,"mapper":null}},
