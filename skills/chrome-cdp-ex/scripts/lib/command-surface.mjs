...
const COMMAND_SURFACE_INPUT = [
  ...
  {"name":"table","aliases":[],"needsTarget":true,"mutates":false,"outputFormats":["text"],"feedbackPolicy":null,"kind":"read","authorization":"standard","evidencePolicy":"none","domains":["Runtime"],"help":{"synopsis":"table <target> [selector]","summary":"Full table data extraction (tab-separated, no row limit)","order":62,"section":"observation"},"mcp":{"exposure":"run-command","toolName":null,"mapper":null}},
