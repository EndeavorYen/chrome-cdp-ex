...
const COMMAND_SURFACE_INPUT = [
  ...
  {"name":"open","aliases":[],"needsTarget":false,"mutates":true,"feedbackPolicy":"full-perceive","outputFormats":["text","json"],"kind":"mutation","authorization":"mutation","evidencePolicy":"action-receipt","domains":["Target","Page","Runtime"],"help":{"synopsis":"open [url] [--perceive] [--attach-timeout-ms N] [--ready-timeout-ms N] [--ready-selector sel] [--reuse-url] [--format json]","summary":"Open a new tab (default: about:blank)","order":77,"section":"discovery"},"mcp":{"exposure":"tool-and-run-command","toolName":"open_or_attach","mapper":"open-or-attach"}},
...
export const COMMAND_SURFACE_IDENTITY = '22454a59f37c7853ca055b0fa42d4760578f56330e2cd5abbdd264c980b83d09';
