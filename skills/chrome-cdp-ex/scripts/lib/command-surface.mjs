...
const COMMAND_SURFACE_INPUT = [
  {"name":"help","aliases":[],"needsTarget":false,"mutates":false,"outputFormats":["text"],"feedbackPolicy":null,"kind":"read","authorization":"standard","evidencePolicy":"none","domains":[],"help":{"synopsis":"help [command]","summary":"Show this command reference (same as --help)","order":0,"section":"discovery"},"mcp":{"exposure":"run-command","toolName":null,"mapper":null}},
  ...
  {"name":"open","aliases":[],"needsTarget":false,"mutates":true,"feedbackPolicy":"report-only","outputFormats":["text","json"],"kind":"mutation","authorization":"mutation","evidencePolicy":"action-receipt","domains":["Target","Page","Runtime"],"help":{"synopsis":"open [url] [--perceive] [--attach-timeout-ms N] [--ready-timeout-ms N] [--ready-selector sel] [--reuse-url] [--format json]","summary":"Open a new tab (default: about:blank)","order":77,"section":"discovery"},"mcp":{"exposure":"tool-and-run-command","toolName":"open_or_attach","mapper":"open-or-attach"}},
  ...
  {"name":"nav","aliases":["navigate"],"needsTarget":true,"mutates":true,"feedbackPolicy":"state-change","outputFormats":["text","json"],"kind":"mutation","authorization":"mutation","evidencePolicy":"action-receipt","domains":["Page","Runtime"],"help":{"synopsis":"nav <target> <url> [--perceive] [--format json]","summary":"Navigate to URL and wait for load completion","order":19,"section":"interaction"},"mcp":{"exposure":"tool-and-run-command","toolName":"navigate","mapper":"navigate"}},
  ...
  {"name":"click","aliases":[],"needsTarget":true,"mutates":true,"feedbackPolicy":"settle-diff","outputFormats":["text","json"],"kind":"mutation","authorization":"mutation","evidencePolicy":"action-receipt","domains":["DOM","Runtime","Input"],"help":{"synopsis":"click <target> <sel|@ref> [--js|-j] [--format json] [--qa|--summary]","summary":"Click element by CSS selector or @ref","order":38,"section":"interaction"},"mcp":{"exposure":"tool-and-run-command","toolName":"click","mapper":"click"}},
  ...
  {"name":"scroll","aliases":[],"needsTarget":true,"mutates":true,"feedbackPolicy":"settle-diff","outputFormats":["text","json"],"kind":"mutation","authorization":"mutation","evidencePolicy":"action-receipt","domains":["Runtime"],"help":{"synopsis":"scroll <target> <dir|x,y|to top|to bottom> [px] [--scroll-container SELECTOR] [--format json]","summary":"Scroll page (down/up/left/right or x,y offset; default 500px; to top/bottom for the window document or nested overflow)","order":43,"section":"interaction"},"mcp":{"exposure":"run-command","toolName":null,"mapper":null}},
  ...
  {"name":"text","aliases":[],"needsTarget":true,"mutates":false,"outputFormats":["text"],"feedbackPolicy":null,"kind":"read","authorization":"standard","evidencePolicy":"none","domains":["Runtime"],"help":{"synopsis":"text <target> [selector|--auto]","summary":"Clean visible text — optional CSS selector to scope","order":61,"section":"observation"},"mcp":{"exposure":"run-command","toolName":null,"mapper":null}},
...
export const COMMAND_SURFACE_IDENTITY = '5615d8bcb85af39f99355e5461196d46839ac5a3fb7d2e08c5b85191d6cdd907';
