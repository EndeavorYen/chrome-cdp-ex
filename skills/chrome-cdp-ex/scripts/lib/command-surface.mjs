...
const COMMAND_SURFACE_INPUT = [
  ...
  {"name":"nav","aliases":["navigate"],"needsTarget":true,"mutates":true,"feedbackPolicy":"state-change","outputFormats":["text","json"],"kind":"mutation","authorization":"mutation","evidencePolicy":"action-receipt","domains":["Page","Runtime"],"help":{"synopsis":"nav <target> <url> [--perceive] [--format json] [--qa|--summary] [--compact]","summary":"Navigate to URL and wait for load completion","order":19,"section":"interaction"},"mcp":{"exposure":"tool-and-run-command","toolName":"navigate","mapper":"navigate"}},
...
export const COMMAND_SURFACE_IDENTITY = '41fbc1bd7f0804d988e0dd0aaceaafcd5b7653cc1d6a031a900648cd97a62222';
